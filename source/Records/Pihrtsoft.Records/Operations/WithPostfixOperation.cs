...
namespace Pihrtsoft.Records.Operations
{
    ...
    internal struct WithPostfixOperation : IPropertyOperation
    {
        public WithPostfixOperation(PropertyDefinition propertyDefinition, string value, int depth, bool rightToLeft = false)
        {
        ...
        public OperationKind Kind => OperationKind.WithPostfix;
